...
class tic_tac_toe:
    ...
    def reset(self):
        ...
        self.bt1.config(text="", state=tk.NORMAL)
        self.bt2.config(text="", state=tk.NORMAL)
        self.bt3.config(text="", state=tk.NORMAL)
        self.bt4.config(text="", state=tk.NORMAL)
        self.bt5.config(text="", state=tk.NORMAL)
        self.bt6.config(text="", state=tk.NORMAL)
        self.bt7.config(text="", state=tk.NORMAL)
        self.bt8.config(text="", state=tk.NORMAL)
        self.bt9.config(text="", state=tk.NORMAL)
